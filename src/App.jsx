...
function App() {
  ...
  const [wfmSchedules, setWfmSchedules] = useState([])
  const [wfmForecasts, setWfmForecasts] = useState([])
            ...
            activeId === 'admin-hub' ? (
              ...
              <div className="legacy-shell">
                <Page
                  ...
                  schedules={wfmSchedules}
                  setSchedules={setWfmSchedules}
                  forecasts={wfmForecasts}
                  setForecasts={setWfmForecasts}
